...
/* Thêm includes này vào đầu file */
#ifdef CONFIG_DEV_GPIO
#include <nuttx/ioexpander/gpio.h>
extern int stm32_pc13led_initialize(int minor);
#endif
...
#ifdef CONFIG_DEV_GPIO
  /* Khởi tạo PC13 LED driver -> /dev/gpio0 */
  ret = stm32_pc13led_initialize(0);
  if (ret < 0)
    {
      _err("ERROR: Failed to register PC13 LED driver: %d\n", ret);
    }
#endif
