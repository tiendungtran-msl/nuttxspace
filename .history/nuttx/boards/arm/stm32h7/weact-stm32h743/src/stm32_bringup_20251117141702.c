...
#ifdef CONFIG_SPI_DRIVER
  /* Register each ICM42688P as separate device */
...
/* Đăng ký I2C cho BMM150 */
#ifdef CONFIG_STM32H7_I2C
  struct i2c_master_s *bmm150;
  /* Khởi tạo I2C1 */
  bmm150 = stm32_i2cbus_initialize(1); // Port I2C1
  if (bmm150 == NULL)
  {
      /* Lỗi khởi tạo I2C1 */
  ...
  ret = i2c_register(bmm150, 1);
  if (ret < 0)
  {
      /* Lỗi đăng ký */
      printf("Failed to register i2c\n");
      stm32_i2cbus_uninitialize(bmm150);
      return ret;
  }
