...
#define GPIO_IMU1_CS  (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_100MHz|GPIO_PORTD|GPIO_PIN11)
#define GPIO_IMU2_CS  (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_100MHz|GPIO_PORTD|GPIO_PIN12)
#define GPIO_IMU3_CS  (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_100MHz|GPIO_PORTD|GPIO_PIN13)
