...
msi-leibniz@MSN:~/nuttxspace/nuttx$ make -j8
Create version.h
LN: platform/board to /home/msi-leibniz/nuttxspace/apps/platform/dummy
Register: gpio
Register: hello
Register: dd
Register: nsh
Register: sh
./chip/stm32_spi.c:193:6: error: #error Not supported SPI123 frequency
  193 | #    error Not supported SPI123 frequency
      |      ^~~~~
ERROR: arm-none-eabi-gcc failed: 1
       command: arm-none-eabi-gcc -MT ./stm32_spi.o  -M '-Wstrict-prototypes' '-Wno-attributes' '-Wno-unknown-pragmas' '-Wno-psabi' '-fomit-frame-pointer' '-fno-common' '-Wall' '-Wshadow' '-Wundef' '-ffunction-sections' '-fdata-sections' '-g' '-mlittle-endian' '-march=armv7e-m' '-mtune=cortex-m7' '-mfpu=fpv5-d16' '-mfloat-abi=hard' '-mthumb' '-Wa,-mthumb' '-Wa,-mimplicit-it=always' '-isystem' '/home/msi-leibniz/nuttxspace/nuttx/include' '-D__NuttX__' '-DNDEBUG' '-D__KERNEL__' '-pipe' '-I' '/home/msi-leibniz/nuttxspace/nuttx/arch/arm/src/chip' '-I' '/home/msi-leibniz/nuttxspace/nuttx/arch/arm/src/common' '-I' '/home/msi-leibniz/nuttxspace/nuttx/arch/arm/src/armv7-m' '-I' '/home/msi-leibniz/nuttxspace/nuttx/sched' ./chip/stm32_spi.c
make[2]: *** [/home/msi-leibniz/nuttxspace/nuttx/tools/Config.mk:232: stm32_spi.ddc] Error 1
