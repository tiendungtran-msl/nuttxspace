...
/* Example placeholders: replace GPIO_PORTx/GPIO_PINy with real pins */
#ifndef GPIO_IMU0_CS
#  define GPIO_IMU0_CS (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_100MHz | \
                        GPIO_PORTA | GPIO_PIN4)
#endif

#ifndef GPIO_IMU1_CS
#  define GPIO_IMU1_CS (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_100MHz | \
                        GPIO_PORTD | GPIO_PIN11) /* TODO: set real pin */
#endif

#ifndef GPIO_IMU2_CS
#  define GPIO_IMU2_CS (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_100MHz | \
                        GPIO_PORTD | GPIO_PIN12) /* TODO: set real pin */
#endif

#ifndef GPIO_IMU3_CS
#  define GPIO_IMU3_CS (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_100MHz | \
                        GPIO_PORTD | GPIO_PIN13) /* TODO: set real pin */
#endif

/* Map 4 logical SPI device IDs to 4 IMUs.
 * SPIDEV_USER(n) is a common NuttX macro for board-specific SPI devices.
 */
#ifndef SPIDEV_IMU0
