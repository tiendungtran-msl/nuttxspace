...
#define STM32_BOARD_XTAL        16000000ul // Thay đổi từ 25MHz thành 16MHz
 ...
 *
 * PLL source is HSE = 16,000,000 (NOT 25 MHz!)
 *
...
#define STM32_PLLCFG_PLL1CFG     (RCC_PLLCFGR_PLL1VCOSEL_WIDE | \
                                  RCC_PLLCFGR_PLL1RGE_8_16_MHZ | \ // Thay đổi từ 4-8 thành 8-16
                                  RCC_PLLCFGR_DIVP1EN | \
                                  RCC_PLLCFGR_DIVQ1EN | \mak
                                  RCC_PLLCFGR_DIVR1EN)

#define STM32_VCO1_FREQUENCY     ((STM32_HSE_FREQUENCY / 2) * 120) // Thay đổi từ 192 thành 120, 5 thành 2
#define STM32_PLL1P_FREQUENCY    (STM32_VCO1_FREQUENCY / 2)
#define STM32_PLL1Q_FREQUENCY    (STM32_VCO1_FREQUENCY / 4)
#define STM32_PLL1R_FREQUENCY    (STM32_VCO1_FREQUENCY / 4)

#define STM32_PLLCFG_PLL1M       RCC_PLLCKSELR_DIVM1(2) // Thay đổi từ 5 thành 2
#define STM32_PLLCFG_PLL1N       RCC_PLL1DIVR_N1(120)   // Thay đổi từ 192 thành 120
...
#define STM32_VCO2_FREQUENCY     ((STM32_HSE_FREQUENCY / 2) * 75) // Thay đổi từ 48 thành 75, 2 thành 2
...
#define STM32_PLLCFG_PLL2N       RCC_PLL2DIVR_N2(75) // Thay đổi từ 48 thành 75
...
#define STM32_PLLCFG_PLL3M       RCC_PLLCKSELR_DIVM3(2) // Thay đổi từ 1 thành 2
#define STM32_PLLCFG_PLL3N       RCC_PLL3DIVR_N3(55) // Thay đổi từ 35 thành 55
#define STM32_PLLCFG_PLL3P       RCC_PLL3DIVR_P3(2)
#define STM32_PLLCFG_PLL3Q       RCC_PLL3DIVR_Q3(2) // Thay đổi từ 1 thành 2
#define STM32_PLLCFG_PLL3R       RCC_PLL3DIVR_R3(10) // Thay đổi từ 20 thành 10

#define STM32_VCO3_FREQUENCY     ((STM32_HSE_FREQUENCY / 2) * 55) // Thay đổi từ 35 thành 55, 1 thành 2
#define STM32_PLL3P_FREQUENCY    (STM32_VCO3_FREQUENCY / 2)
#define STM32_PLL3Q_FREQUENCY    (STM32_VCO3_FREQUENCY / 2) // Thay đổi từ /1 thành /2
#define STM32_PLL3R_FREQUENCY    (STM32_VCO3_FREQUENCY / 10) // Thay đổi từ /20 thành /10
