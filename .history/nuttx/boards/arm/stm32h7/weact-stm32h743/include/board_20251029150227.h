...
/* PLL1: HSE 16 MHz, PLLM=2, PLLN=100
 *
 *   PLL input = 16 MHz / 2 = 8 MHz ✅ (trong range 4-8 MHz)
 *   PLL1_VCO = 8 MHz × 100 = 800 MHz ✅ (< 836 MHz)
 *
 *   PLL1P = 800 MHz / 2 = 400 MHz → SYSCLK
 *   PLL1Q = 800 MHz / 4 = 200 MHz
 *   PLL1R = 800 MHz / 4 = 200 MHz
 */
...
#define STM32_VCO1_FREQUENCY     ((STM32_HSE_FREQUENCY / 2) * 100)  // 800 MHz
#define STM32_PLL1P_FREQUENCY    (STM32_VCO1_FREQUENCY / 2)          // 400 MHz
#define STM32_PLL1Q_FREQUENCY    (STM32_VCO1_FREQUENCY / 4)          // 200 MHz
#define STM32_PLL1R_FREQUENCY    (STM32_VCO1_FREQUENCY / 4)          // 200 MHz

#define STM32_PLLCFG_PLL1M       RCC_PLLCKSELR_DIVM1(2)   // 16/2 = 8 MHz
#define STM32_PLLCFG_PLL1N       RCC_PLL1DIVR_N1(100)     // 8×100 = 800 MHz
#define STM32_PLLCFG_PLL1P       RCC_PLL1DIVR_P1(2)       // 800/2 = 400 MHz
#define STM32_PLLCFG_PLL1Q       RCC_PLL1DIVR_Q1(4)       // 800/4 = 200 MHz
#define STM32_PLLCFG_PLL1R       RCC_PLL1DIVR_R1(4)       // 800/4 = 200 MHz
