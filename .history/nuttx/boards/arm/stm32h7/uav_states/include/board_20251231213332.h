/****************************************************************************
 * boards/arm/stm32h7/uav_states/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H
...
/* I2C1 BMM150 */
#define GPIO_I2C1_SCL   (GPIO_I2C1_SCL_1 | GPIO_SPEED_100MHz)  /* PB6 */
#define GPIO_I2C1_SDA   (GPIO_I2C1_SDA_1 | GPIO_SPEED_100MHz)  /* PB7 */

/* SPI1 ICM42688P (Only SCK and MOSI pins) */
...
/* Định nghĩa ID cho thiết bị SPI */
#define SPIDEV_ICM0 SPIDEV_IMU(0)
#define SPIDEV_ICM1 SPIDEV_IMU(1)
#define SPIDEV_ICM2 SPIDEV_IMU(2)
#define SPIDEV_ICM3 SPIDEV_IMU(3)

/* LED TEST */
#define GPIO_LED_STATUS  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_PULLUP | \
                         GPIO_SPEED_2MHz | GPIO_PORTC | GPIO_PIN0)
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H */
