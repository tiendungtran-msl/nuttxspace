 ...
 * RESET - Active low reset (directly active low, no external pull-up needed)
 * Note: SAFEBOOT and LNA_EN optional, directly active high/low
 */
#define GPIO_GPS_PPS      (GPIO_INPUT | GPIO_FLOAT | GPIO_EXTI | GPIO_PORTB | GPIO_PIN5)  /* PB5 - TIMEPULSE */
