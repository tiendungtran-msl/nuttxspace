/************************************************************************************
 * nuttx/boards/arm/stm32h7/uav_states/include/board.h

 ************************************************************************************/
#ifndef __NUTTX_BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H
#define __NUTTX_BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H
...
/* Do not include STM32 H7 chip header files here */
...
/* UART/USART
 * USART1 is console
 * UART4 is connecting to GPS
 * UART8 used for telemetry
 */

#define GPIO_USART1_RX  GPIO_USART1_RX_2  /* PA9 */
#define GPIO_USART1_TX  GPIO_USART1_TX_2  /* PA10 */
 ...
 * PPS   - Pulse Per Second timing signal (input with interrupt)
 * RESET - Active low reset
 */
/*
 * PPS (TIMEPULSE) is optional.
 * Keep it as a plain input by default to avoid EXTI-related IRQ storms/resets
 * when the pin is noisy or the PPS output type is not as expected.
 */
#define GPIO_GPS_PPS      (GPIO_INPUT | GPIO_PULLUP | GPIO_PORTB | GPIO_PIN5)  /* PB5 - TIMEPULSE */
#define GPIO_GPS_RESET_N  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | GPIO_OUTPUT_SET | GPIO_PORTB | GPIO_PIN4)  /* PB4 - RESET_N active low */

/* Buzzer, Switch, LED */
#define GPIO_BUZZER       (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | GPIO_PORTA | GPIO_PIN11)  /* PA11 */
...
#endif  /* __NUTTX_BOARDS_ARM_STM32H7_UAV_STATES_INCLUDE_BOARD_H */