...
#define SPIDEV_ICM0 #define SPIDEV_IMU(n)           SPIDEV_ID(SPIDEVTYPE_IMU,           (n))

#define SPIDEV_ICM1 SPIDEV_CUSTOM(1,1)
#define SPIDEV_ICM2 SPIDEV_CUSTOM(1,2)
#define SPIDEV_ICM3 SPIDEV_CUSTOM(1,3)
