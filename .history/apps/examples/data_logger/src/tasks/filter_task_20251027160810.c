...
/*
* Trạng thái bộ lọc cho mỗi cảm biến
* Giữ mảng vòng các mẫu gần đây để tính toán
*/
...
* Nhiệm vụ bộ lọc
* arg: Không sử dụng
* Cơ chế: Nhận dữ liệu cảm biến từ hàng đợi, áp dụng bộ
*         lọc trượt, gửi dữ liệu đã lọc đến lưu trữ và hiển thị
*/
