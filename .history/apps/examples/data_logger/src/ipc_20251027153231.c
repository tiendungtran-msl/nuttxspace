...
/*
* Hàm khởi tạo IPC: tạo message queues và mutex
* Trả về OK nếu thành công, -errno nếu lỗi
* Cơ chế: Thiết lập thuộc tính cho từng queue gồm số lượng tin nhắn, kích thước từng tin, cờ và sau đó gọi mq_open để tạo
*/
