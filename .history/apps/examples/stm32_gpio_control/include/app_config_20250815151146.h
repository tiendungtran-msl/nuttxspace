...
#define APP_GPIO_DEVICE_PATH    "/dev/gpin13"  /* Changed to gpin for input/output */

/* Alternative device paths to try */
#define APP_GPIO_DEVICE_PATH_ALT1 "/dev/gpout13"
#define APP_GPIO_DEVICE_PATH_ALT2 "/dev/gpio13"
