 ...
 *
 * SPI Manager - NuttX SPI Transfer Driver
 *
 ****************************************************************************/
...
int spi_manager_write_regs(uint8_t devid, uint8_t reg,
