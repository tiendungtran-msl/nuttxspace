...
typedef struct
{
  FAR struct i2c_master_s *i2c;    /* I2C device handle */
  uint8_t addr;                    /* I2C address */
  bool initialized;

  bmm150_trim_data_t trim;        /* Factory trim data */
  bmm150_cal_data_t cal;          /* User calibration data */
  bmm150_mag_data_t bmm150_data;
  float yaw;                     /* Last computed heading/yaw */
