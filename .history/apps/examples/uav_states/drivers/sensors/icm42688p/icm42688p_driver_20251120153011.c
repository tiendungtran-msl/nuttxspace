...
int icm42688p_get_datas(icm42688p_dev_t *dev, icm42688p_data_t *data)
{
  int ret;
  ...
  dev->gyro.x = ((float)dev->gyro.x / dev->gyro_sensitivity) - dev->gyro_offset.x;
  dev->gyro.y = ((float)dev->gyro.y / dev->gyro_sensitivity) - dev->gyro_offset.y;
  dev->gyro.z = ((float)dev->gyro.z / dev->gyro_sensitivity) - dev->gyro_offset.z;
