...
/* Khởi tạo cảm biến icm42688p với chân theo mã id */
int icm42688p_init(icm42688p_dev_t *dev, uint8_t id);

/* Hủy khởi tạo cảm biến icm42688p */
...
/* Đọc dữ liệu trong thanh ghi */
int icm42688p_read_register(icm42688p_dev_t *dev, uint8_t reg, uint8_t *value);

/* Đọc nhiều thanh ghi liên tiếp */
int icm42688p_read_registers(icm42688p_dev_t *dev, uint8_t reg, uint8_t *buffer, size_t length);
...
/* Thực hiện bài kiểm tra tự động của cảm biến */
...
/* Tính toán góc pitch, roll từ dữ liệu gia tốc */
int icm42688p_orientation(icm42688p_dev_t *dev);

/* Thực hiện soft reset cảm biến */
