...
int icm42688p_get_data(icm42688p_dev_t *dev, icm42688p_data_t *data)
{
  ...
  icm42688p_convert_accel_data(dev, data->accel_x, data->accel_y, data->accel_z, &data->accel);
  icm42688p_convert_gyro_data(dev, data->gyro_x, data->gyro_y, data->gyro_z, &data->gyro);
  data->temperature = icm42688p_convert_temperature(data->temp);
