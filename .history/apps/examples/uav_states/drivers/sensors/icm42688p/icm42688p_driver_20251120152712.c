...
int icm42688p_get_data(icm42688p_dev_t *dev, icm42688p_data_t *data)
{
  ...
  icm42688p_convert_accel_data(dev, dev->accel.x, dev->accel.y, dev->accel.z, &data->accel);
  icm42688p_convert_gyro_data(dev, dev->gyro.x, dev->gyro.y, dev->gyro.z, &data->gyro);
  data->temperature = icm42688p_convert_temperature(dev->temp);
