...
int icm42688p_get_data(icm42688p_dev_t *dev)
{
  ...
  dev->accel_calib.x = (float)dev->accel.x / dev->accel_sensitivity;
  dev->accel_calib.y = (float)dev->accel.y / dev->accel_sensitivity;
  dev->accel_calib.z = (float)dev->accel.z / dev->accel_sensitivity;
