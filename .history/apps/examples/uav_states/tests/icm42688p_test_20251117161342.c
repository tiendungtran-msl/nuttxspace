...
/* Cấu hình SPI của bạn – sửa nếu khác */
#ifndef CONFIG_UAV_STATES_ICM42688P_SPI_BUS
#  define SPI_BUS   1
#  define SPI_CS    0
#else
#  define SPI_BUS   CONFIG_UAV_STATES_ICM42688P_SPI_BUS
#  define SPI_CS    CONFIG_UAV_STATES_ICM42688P_DEVID
#endif
...
int icm42688p_test_main(int argc, char *argv[])
{
    ...
    /* 1. Khởi tạo */
    ret = icm42688p_init(&dev, SPI_BUS, SPI_CS);
    if (ret != ICM42688P_OK)
    {
    ...
    ret = icm42688p_read_reg(&dev, 0x75, &whoami);   // Register WHO_AM_I
