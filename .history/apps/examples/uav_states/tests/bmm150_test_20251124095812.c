...
#define BMM150_TEST_I2C_PORT      1
#define BMM150_TEST_I2C_ADDR      BMM150_DEFAULT_I2C_ADDRESS
...
int bmm150_yaw_test(void)
{
  ...
  printf("\n[BMM150 Test] Init I2C dev on port %d...\n", BMM150_TEST_I2C_PORT);
  dev.i2c = i2c_init(BMM150_TEST_I2C_PORT);
  if (!dev.i2c)
    {
