...
namespace drivers {
    namespace spi {
        ...
        /**
         * @brief initialization types for SPI drivers
         * 
         * 1. SPI transfer modes
         * 2. Lock modes for thread safety
         * 3. SPI configuration structure
         * 4. Transfer result structure
         */
        ...
        enum class LockMode : uint8_t {
            ...
            PREEMPTION          // Critical section (disabl=e IRQ)
        };
