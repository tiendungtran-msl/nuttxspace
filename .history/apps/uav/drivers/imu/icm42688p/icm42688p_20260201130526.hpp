/****************************************************************************
 * apps/uav/drivers/imu/icm42688p/icm42688p.hpp
 *
 * ICM-42688-P IMU Driver
 * Adapted from PX4 for Pure NuttX
 *
 * TÍNH NĂNG:
 * - SPI interface @ 10MHz
 * - 6-DOF: Gyroscope + Accelerometer
 * - Configurable range và ODR
 * - Calibration support (bias, scale, rotation)
 ****************************************************************************/
...
namespace drivers {
    namespace imu {
        ...
        public:
            ...
            /**
             * Calibration API sử dụng sensor_calibration library
             */
            ...
            /**
             * Legacy API cho backward compatibility
             */
            ...
            /**
             * Debug helper: read register trong bank cụ thể
             */
