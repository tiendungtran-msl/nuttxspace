/****************************************************************************
 * apps/uav/drivers/spi/spi_device.hpp
 *
 * Base class cho SPI devices (Pure NuttX)
 *
 * TÍNH NĂNG:
 * - Thread-safe transfers (mutex hoặc critical section)
 * - Dynamic frequency switching
 * - 8-bit và 16-bit transfers
...
namespace drivers {
    namespace spi {
        ...
        /**
         * @brief Base class cho SPI devices
         */
        class Device {
        public:
            /**
            ...
            /**
             * Kiểm tra device đã được init chưa
             */
        ...
        protected:
            /**
             * Probe function - override để check device presence
             *
            ...
            /**
             * Lấy device handle (for advanced users)
             */
        ...
        private:
            ...
            irqstate_t _irq_flags;  /* Cho critical section */
