 ...
 *
 * MỤC ĐÍCH:
 * - Định nghĩa cấu trúc packet nhị phân 128 bytes
 * - Dùng chung cho MCU (C) và PC tool (Python decode)
 * - Fixed-size, CRC16 protected
 *
 * PACKET LAYOUT:
 *   [Header 8B][IMU 28B][Mag 12B][Baro 8B][GPS 24B][Att 32B][Status 16B][Footer 4B]
 *   Total: 128 bytes
 *
 ****************************************************************************/
...
#define TELEM_IMU_OFFSET        8
#define TELEM_MAG_OFFSET        36
#define TELEM_BARO_OFFSET       48
#define TELEM_GPS_OFFSET        56
#define TELEM_ATTITUDE_OFFSET   80
#define TELEM_STATUS_OFFSET     112
#define TELEM_FOOTER_OFFSET     124
