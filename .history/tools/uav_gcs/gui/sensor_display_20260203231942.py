...
class ValueLabel(QLabel):
    ...
    def __init__(self, width: int = 100, decimals: int = 3, unit: str = "", parent=None):
        ...
        self.setMaximumWidth(width + 40)  # Allow some stretch
...
class ImuFusionPanel(QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        for i in range(4):
            ...
            imu_num.setMinimumWidth(30)
            imu_num.setMaximumWidth(40)
            ...
            for axis in ['gx', 'gy', 'gz', 'ax', 'ay', 'az']:
                ...
                imu_data[axis] = lbl
                row.addWidget(lbl, 1)  # Stretch factor 1
        ...
        fused_lbl.setMinimumWidth(30)
        fused_lbl.setMaximumWidth(40)
        ...
        for axis in ['gx', 'gy', 'gz', 'ax', 'ay', 'az']:
            ...
            fused_row.addWidget(lbl, 1)  # Stretch factor 1
...
class SensorGroup(QGroupBox):
    ...
    def add_vector(self, name: str, components: list = ['X', 'Y', 'Z'], 
        ...
        for comp in components:
            ...
            comp_label.setMinimumWidth(10)
            comp_label.setMaximumWidth(15)
            
            value_label = ValueLabel(65, decimals, "")
            labels[comp] = value_label
            
            vec_layout.addWidget(comp_label)
            vec_layout.addWidget(value_label, 1)  # Stretch factor 1
