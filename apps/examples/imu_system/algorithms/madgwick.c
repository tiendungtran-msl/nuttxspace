/****************************************************************************
 * apps/examples/imu_system/algorithms/madgwick.c
 *
...
void madgwick_update(float gx, float gy, float gz,
  (void)mx; (void)my; (void)mz;
                     ...
                     float dt)
{
  /* Simplified - use IMU version for now */
  madgwick_update_imu(gx, gy, gz, ax, ay, az, dt);
}

void madgwick_get_quaternion(float *q0_out, float *q1_out, 
                             float *q2_out, float *q3_out)
{
  *q0_out = q0;
  *q1_out = q1;
  *q2_out = q2;
