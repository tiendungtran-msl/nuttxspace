/****************************************************************************
 * apps/examples/uav_states_v1/calibration/sensor_calibration.hpp
 *
 * Sensor calibration library - inspired by PX4 sensor_calibration
 * Provides bias, scale, and rotation matrix correction for IMU sensors
 ****************************************************************************/
...
/**
 * @brief 3x3 Direction Cosine Matrix for rotation
 */
class Dcmf
{
public:
...
/**
 * @brief Accelerometer calibration parameters and correction
 * 
...
public:
    ...
    /**
     * @brief Apply calibration to raw accelerometer data
    ...
    /**
     * @brief Reset to default (identity) calibration
     */
    void reset();

    /**
     * @brief Check if calibration has been modified from default
     */
    bool is_calibrated() const { return _calibration_count > 0; }

    /**
     * @brief Get number of times calibration has been updated
     */
...
/**
 * @brief Gyroscope calibration parameters and correction
 * 
...
public:
    ...
    /**
     * @brief Apply calibration to raw gyroscope data
